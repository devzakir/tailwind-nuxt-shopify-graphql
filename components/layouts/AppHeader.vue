    ...
    -->
      <div class="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
        ...
        <div class="border-t border-gray-200 py-6 px-4 space-y-6">
          <div class="flow-root">
            <nuxt-link :to="{ name: 'products-slug', params: {slug: 'test'}}" class="-m-2 p-2 block font-medium text-gray-900">
              Product Details
            </nuxt-link>
          </div>
          <div class="flow-root">
            <nuxt-link :to="{ name: 'order-summary'}" class="-m-2 p-2 block font-medium text-gray-900">
              Order Summary
            </nuxt-link>
          </div>

          <div class="flow-root">
            <nuxt-link :to="{ name: 'checkout'}" class="-m-2 p-2 block font-medium text-gray-900">
              Checkout
            </nuxt-link>
          </div>
        </div>
        ...
        <div class="border-t border-gray-200 py-6 px-4 space-y-6">
          <div class="flow-root">
            <nuxt-link :to="{ name: 'auth-login'}" class="-m-2 p-2 block font-medium text-gray-900" />
          </div>
          <div class="flow-root">
          ...
          <div class="h-16 flex items-center">
            ...
            <div class="hidden lg:ml-8 lg:block lg:self-stretch">
              <div class="h-full flex space-x-8">
                <nuxt-link :to="{ name: 'products-slug', params: {slug: 'test'}}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                  Product Details
                </nuxt-link>

                <nuxt-link :to="{ name: 'order-summary'}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                  Order Summary
                </nuxt-link>

                <nuxt-link :to="{ name: 'checkout'}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                  Checkout
                </nuxt-link>
              </div>
            </div>
            ...
            <div class="ml-auto flex items-center">
              <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                <nuxt-link :to="{ name: 'auth-login'}" class="text-sm font-medium text-gray-700 hover:text-gray-800">
                  Sign in
                </nuxt-link>
