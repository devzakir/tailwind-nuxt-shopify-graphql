<template>
  <section class="py-24 2xl:py-44 bg-blueGray-100 rounded-t-10xl overflow-hidden">
    <div class="container px-4 mx-auto">
            ...
            <div class="flex flex-wrap items-center justify-between w-full -mx-2">
              <div class="w-full md:w-auto px-2 mb-4 md:mb-0">
                <a class="block mx-auto max-w-max" href="#">
                  <img class="h-24 object-cover" src="uinel-assets/images/ecommerce-reviews/product-phone1.png" alt="">
                </a>
              </div>
              <div class="w-full md:w-auto px-2 mb-8 md:mb-0">
                <a class="block mb-2 text-2xl xl:text-3xl font-heading font-medium hover:underline" href="#">Apple iPhone 12 Pro</a>
                <div class="flex">
              ...
              <div class="w-full md:w-auto px-2">
                <a class="inline-block w-full md:w-auto py-4 px-6 text-center leading-8 font-heading font-medium tracking-tighter text-xl text-white bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl" href="#">Add&nbsp;to&nbsp;cart</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <a class="inline-block mb-14 text-3xl font-heading font-medium underline hover:text-darkBlueGray-700" href="#">1,218 reviews</a>
      <div class="mb-2 shadow-lg rounded-t-8xl rounded-b-5xl overflow-hidden">
        <div class="pt-3 pb-3 md:pb-1 px-4 md:px-16 bg-white bg-opacity-40">
          <div class="flex flex-wrap items-center">
            ...
            <div class="w-full md:w-px h-2 md:h-8 mx-8 bg-transparent md:bg-gray-200" />
              ...
              <div class="-mb-2">
                <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                  <div class="flex items-center h-12 pl-2 pr-6 bg-green-100 border-2 border-green-500 rounded-full">
                    ...
                    <span class="text-green-500 font-heading font-medium">battery life</span>
                  </div>
                </div>
                <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                  <div class="flex items-center h-12 pl-2 pr-6 bg-green-100 border-2 border-green-500 rounded-full">
                    ...
                    <span class="text-green-500 font-heading font-medium">functionality</span>
                  </div>
                </div>
                <div class="inline-flex w-full md:w-auto mb-2">
                  <div class="flex items-center h-12 pl-2 pr-6 bg-green-100 border-2 border-green-500 rounded-full">
                    ...
                    <span class="text-green-500 font-heading font-medium">ease of use</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="mb-2 shadow-lg rounded-t-8xl rounded-b-5xl overflow-hidden">
        <div class="pt-3 pb-3 md:pb-1 px-4 md:px-16 bg-white bg-opacity-40">
          <div class="flex flex-wrap items-center">
            <img class="mr-6" src="uinel-assets/images/ecommerce-reviews/user2.png" alt="">
            <h4 class="w-full md:w-auto text-xl font-heading font-medium">
              Ainsley Stones
            </h4>
            <div class="w-full md:w-px h-2 md:h-8 mx-8 bg-transparent md:bg-gray-200" />
        ...
        <div class="px-4 md:px-16 pt-8 pb-12 bg-white">
          <div class="flex flex-wrap">
            <div class="w-full md:w-2/3 mb-6 md:mb-0">
              <p class="mb-8 max-w-2xl text-darkBlueGray-400 leading-loose">
                I haretra neque non mi aliquam, finibus hart bibendum molestie. Morbi facilisis neque in condimentum malesuada. Vestibulum suscipit sagittis dignissim mauris.
              </p>
              <div class="-mb-2">
                <div class="inline-flex w-full md:w-auto md:mr-2 mb-2">
                  <div class="flex items-center h-12 pl-2 pr-6 bg-green-100 border-2 border-green-500 rounded-full">
      ...
      <div class="mb-14 md:mb-24 shadow-lg rounded-t-8xl rounded-b-5xl overflow-hidden">
        <div class="pt-3 pb-3 md:pb-1 px-4 md:px-16 bg-white bg-opacity-40">
          <div class="flex flex-wrap items-center">
            <img class="mr-6" src="uinel-assets/images/ecommerce-reviews/user3.png" alt="">
            <h4 class="w-full md:w-auto text-xl font-heading font-medium">
              Jasmine Joy
            </h4>
            <div class="w-full md:w-px h-2 md:h-8 mx-8 bg-transparent md:bg-gray-200" />
